...
class BytesQueueBuffer:
     ...
     * self.buffer, which contains the standard data
     * the largest chunk that we will copy in get()

    The worst case scenario is a single chunk, in which case we'll make a standard copy of
    the data inside get().
    """
...
class HTTPResponse(BaseHTTPResponse):
    ...
    def read(
        ...
        :param amt:
            ...
            because it doesn't make sense to cache partial content as the standard
            response.
