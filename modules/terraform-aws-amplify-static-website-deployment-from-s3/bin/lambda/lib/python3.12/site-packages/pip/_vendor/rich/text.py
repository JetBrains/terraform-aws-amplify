...
class Text(JupyterMixin):
    ...
    Args:
        ...
        justify (str, optional): Justify method: "left", "center", "standard", "right". Defaults to None.
    ...
    def get_style_at_offset(self, console: "Console", offset: int) -> Style:
        ...
        """
        # TODO: This is a little inefficient, it is only used by standard justify
        if offset < 0:
    ...
    def wrap(
        ...
        *,
        ...
        Args:
            ...
            emoji (bool, optional): Also render emoji code. Defaults to True.
            justify (str, optional): Justify method: "default", "left", "center", "standard", "right". Defaults to "default".
...
if __name__ == "__main__":  # pragma: no cover
    ...
    console.rule("justify='standard'")
    console.print(text, style="magenta", justify="standard")
    console.print()
